...
def execution(request):
    ...
    return render(request, 'services/execution/execution.html', locals())

def list_execution(request):
    get_data = requests.get(typemission)
    data_list = get_data.json()
    return render(request, "services/execution/list_execution.html", locals())
...
def edit_execution(request, pk):
    ...
    return render(request, "services/execution/form_execution.html", locals())
...
def del_execution(request, pk):
    ...
    return render(request, "services/execution/del_execution.html", locals())
