...
def transmission_justificatifs(request):
    ...
    return render(request, 'services/transmission_justificatifs/transmission_justificatifs.html', locals())

def list_transmission_justificatifs(request):
    get_data = requests.get(typemission)
    data_list = get_data.json()
    return render(request, "services/transmission_justificatifs/list_transmission_justificatifs.html", locals())
...
def edit_transmission_justificatifs(request, pk):
    ...
    return render(request, "services/transmission_justificatifs/form_transmission_justificatifs.html", locals())
...
def del_transmission_justificatifs(request, pk):
    ...
    return render(request, "services/transmission_justificatifs/del_transmission_justificatifs.html", locals())
